...
# and the response 'Hello World!' is returned to the browser.
@app.route('/')
def head():
    return 'Hello World!'
...
# if you want to run it on port 3000, not 5000, so write it: app.run(debug=True, port=3000)
# if you want to run it on port 3000, not 5000, so write it: app.run(host= '0.0.0.0', port=80)